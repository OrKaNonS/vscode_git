// 프라퍼티디스크립터 (property descriptor)
// : 프라퍼티의 속성값들을 저장하고 잇는 객체
// 프라퍼티의 속성값
// value : 프라퍼티의 값
// writable : 수정가능 여부 (기본값: true)
// enumerable : 열거가능 여부 (기본값: true)
...
// person객체의 name 프라퍼티의 디스크립터 (데이터값 프라퍼티)
...
// hong객체의 fullName프라퍼티(메소드)의 디스크립터 (접근자 프라퍼티)
...
// 프라퍼티 열거
// gender는 enumerable:false 이므로 name, fullName만 나옴 - 결과:[ 'name', 'fullName' ]
...
// 객체 확장금지, 밀봉, 동결
// 확장금지 : Object.preventExtensions => 프라퍼티 추가 금지
// 밀봉 : Object.seal => 프라퍼티 추가/삭제 금지(읽기/쓰기만 가능)
