...
// 1. 일반함수 : 객체생성 가능, 상속 가능
// 2. 메서드 : 객체생성 불가, 상속 불가
// 3. 화살표함수 : 기능만 정의, this 바인딩 안함(=화살표함수내에서의 this는 상위스코프를 따름.)
...
// 파라미터가 1개만 있을때는 ()를 생략 가능
const af2 = x => {};

// 파라미터가 2개 이상 있을때는 ()를 생략 불가
const af3 = (x, y) => {};

// 반환값이 한개면 return과 {}을 생략 가능
// const af4 = x => return {x*x;}
const af4 = x => x*x;

// 객체리터럴을 반환한다면 ()로 묶어줘야 함
const af5 = () => ({name:'홍길동', age:20}) // () 없으면 error 발생
...
console.log(add()); // 0 0 0 (파라미터 개수, 인자 개수, 다 더한값)
