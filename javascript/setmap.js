// Set
// - 요소의 중복을 혀용하지 않는 자료구조 = 동일한 값은 한번만 저장
// - 요소의 순서(인덱스) 없는 자료구조
...
// Set 요소크기
console.log(new Set([1, 2, 3, 4, 5]).size); // 5
...
set4.forEach((v1, v2, set) => {
    console.log(v1, v2, set); // 1 2 3 4 5
});
...
// Map은 이터러블 : for ~ of 사용가능, 스프레드 가능, 구조분해할당 가능
